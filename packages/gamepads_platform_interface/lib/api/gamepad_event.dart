...
/// change on the state of the connected/disconnected state.
class GamepadConnectedEvent {
  ...
  @override
  String toString() {
    return '[$gamepadId] $isConnected';
  }

  factory GamepadConnectedEvent.parse(Map<dynamic, dynamic> map) {
    final gamepadId = map['gamepadId'] as String;
    final timestamp = map['time'] as int;
    final isConnected = map['isConnected'] as bool;
